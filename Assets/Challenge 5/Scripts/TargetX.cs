...
public class TargetX : MonoBehaviour
{
    ...
    private readonly float _minValueX = -3.75f; // the x value of the center of the left-most square
    private readonly float _minValueY = -3.75f; // the y value of the center of the bottom-most square
    private readonly float _spaceBetweenSquares = 2.5f; // the distance between the centers of squares on the game board
